...
public class GameData
{
	...
	public static void CreateLightMapArray(int worldId, int numMaps, AssetBundle assetBundle)
	{
		...
		for (int i = 0; i < numMaps; i++)
		{
			...
			lightmapData.lightmapColor = (assetBundle.LoadAsset("LightmapFar-" + i.ToString(), typeof(Texture2D)) as Texture2D);
	...
	private static IEnumerator WaitForSpawnPointsRequest(WWW www)
	{
		...
		{
			abr2 = assetBundle.LoadAssetAsync(assetToFind2, typeof(TextAsset));
			yield return abr2;
